...
namespace UnityEditor.UI
{
    ...
    public class ProceduralImageEditor : ImageEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            proceduralImage = (ProceduralImage)target;

            if (proceduralImage.GetComponent<ProceduralImageModifier>() != null)
            {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            proceduralImage.Radius = EditorGUILayout.FloatField(nameof(proceduralImage.Radius), proceduralImage.Radius);
